...
var configurationsResource = schema.GroupVersionResource{Group: "configuration.nginx.ingress.kubernetes.io", Version: "v1alpha1", Resource: "configurations"}

var configurationsKind = schema.GroupVersionKind{Group: "configuration.nginx.ingress.kubernetes.io", Version: "v1alpha1", Kind: "Configuration"}
